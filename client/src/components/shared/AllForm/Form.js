    ...
    <div>
      ...
      <div className="d-flex mb-3">
        <div className="form-check">
          <input type="radio" className="form-check-input" name="role" id="adminRadio" value={'donor'} onChange={(e)=> setRole(e.target.value)} defaultChecked/>
      ...
      {role === 'organization' && (
         <InputType labelText={'Organization Name'} labelFor={'forOrganizationName'} inputType={'text'} name={'organizationName'} value={organizationName}
